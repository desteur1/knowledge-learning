 ...
 */
final class Version20260423081156 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cursus CHANGE title name VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE lesson CHANGE title name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cursus CHANGE name title VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE lesson CHANGE name title VARCHAR(255) NOT NULL');
