 ...
 */
final class Version20260511165320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cursus DROP price');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cursus ADD price INT NOT NULL');
