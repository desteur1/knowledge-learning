 ...
 */
final class Version20260514102546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_user_lesson ON lesson_validation (user_id, lesson_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX unique_user_lesson ON lesson_validation');
