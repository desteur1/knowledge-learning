 ...
 */
final class Version20260508070430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cursus CHANGE price price INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE lesson CHANGE price price INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cursus CHANGE price price DOUBLE PRECISION NOT NULL');
        ...
        $this->addSql('ALTER TABLE lesson CHANGE price price DOUBLE PRECISION NOT NULL');
